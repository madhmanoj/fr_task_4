...
export class BrowserWasiProcess extends WasiProcess {
	...
	protected async startMain(wasiService: WasiService, imports: string): Promise<void> {
		...
		const message: StartMainMessage = { method: 'startMain', module: await this.module, memory: this.memory, trace: this.options.trace !== undefined, imports: imports };
